...
public class Story2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myBitmap = decodeSampledBitmapFromResource(getResources(), R.drawable.im201, height1, width1 );
	...
	{
	    super.onBackPressed(); 
	    startActivity(new Intent(Story2.this, StartScreen.class));
	    finish();
    	...
    	i--;
 		if(i <10)
 		{
 			if(i < 1)
 				{
 				i =1;
 				Intent myIntent = new Intent(Story2.this, StartScreen.class);
 				Story2.this.startActivity(myIntent);
 				}

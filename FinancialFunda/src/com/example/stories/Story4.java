...
public class Story4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myBitmap = decodeSampledBitmapFromResource(getResources(), R.drawable.im401, height1, width1 );
	...
	{
	    super.onBackPressed(); 
	    startActivity(new Intent(Story4.this, StartScreen.class));
	    finish();
	    	...
	    	i--;
     		if(i <10)
     		{
     			if(i < 1)
     				{
     				i =1;
     				Intent myIntent = new Intent(Story4.this, StartScreen.class);
     				Story4.this.startActivity(myIntent);
     				}
